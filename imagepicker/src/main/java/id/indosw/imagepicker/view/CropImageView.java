package id.indosw.imagepicker.view;
...
@SuppressWarnings({"FieldMayBeFinal", "UnusedAssignment", "IntegerDivisionInFloatingPointContext", "SuspiciousNameCombination", "SameParameterValue", "ResultOfMethodCallIgnored", "unused"})
