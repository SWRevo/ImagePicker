...
import id.indosw.imagepicker.sample.imageloader.GlideImageLoader;
import id.indosw.imagepicker.sample.imageloader.PicassoImageLoader;
import id.indosw.imagepicker.sample.imageloader.UILImageLoader;
import id.indosw.imagepicker.sample.imageloader.XUtils3ImageLoader;
import id.indosw.imagepicker.sample.wxdemo.WxDemoActivity;
import id.indosw.imagepicker.ui.ImageGridActivity;
import id.indosw.imagepicker.view.CropImageView;
        ...
        switch (v.getId()) {
            case R.id.btn_open_gallery:
                ...
                if (rb_crop_square.isChecked()) {
                    ...
                    int width = Integer.parseInt(et_crop_width.getText().toString());
                    int height = Integer.parseInt(et_crop_height.getText().toString());
                    ...
                    int radius = Integer.parseInt(et_crop_radius.getText().toString());
                ...
                imagePicker.setOutPutX(Integer.parseInt(et_outputx.getText().toString()));
                imagePicker.setOutPutY(Integer.parseInt(et_outputy.getText().toString()));
